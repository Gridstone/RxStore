...
```groovy
compile 'au.com.gridstone.rxstore:rxstore:5.0.1'
```
For the kotlin convenience functions
```groovy
compile 'au.com.gridstone.rxstore:rxstore-kotlin:5.0.1'
```
For the Moshi converter
```groovy
compile 'au.com.gridstone.rxstore:converter-moshi:5.0.1'
```
For the Gson converter
```groovy
compile 'au.com.gridstone.rxstore:converter-gson:5.0.1'
```
For the Jackson converter
```groovy
compile 'au.com.gridstone.rxstore:converter-jackson:5.0.1'
```
