...
class GsonConverterTest {
  ...
  @Test fun convertValue() {
    val store = RxStore.value<TestData>(tempDir.newFile(), GsonConverter(), TestData::class.java)
  ...
  @Test fun convertList() {
    val store = RxStore.list<TestData>(tempDir.newFile(), GsonConverter(), TestData::class.java)
