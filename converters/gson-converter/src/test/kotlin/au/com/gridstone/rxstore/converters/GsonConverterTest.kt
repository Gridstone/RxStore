...
class GsonConverterTest {
  ...
  @Test fun convertValue() {
    val store = ValueStore<TestData>(tempDir.newFile(), GsonConverter(), TestData::class.java)
  ...
  @Test fun convertList() {
    val store = ListStore<TestData>(tempDir.newFile(), GsonConverter(), TestData::class.java)
